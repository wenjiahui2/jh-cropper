<template>
  <div id="add">
    ...
    >
      <div class="el-cropper" style="height: 500px">
        <div>
          <div class="cropper-content">
            ...
            <div class="show-preview" :style="{ overflow: 'hidden' }">
              ...
              <div class="detailsclass">
                <p class="">详情：</p>
                <p v-text="options.details" :title="options.details">
                  建议：图片宽高比例1.5:1
                  支持格式：jpg、png、jpeg
                </p>
              </div>
        ...
        <div>
          <div class="footer-btn">
            <div class="scope-btn">
              ...
              <div class="scoper-fun">
                ...
                <el-button
                  ...
                  >-</el-button
                >
                <el-button type="" @click="rotateLeft" class="l-btn"
                  ><span style="font-weight: 600">↺</span></el-button
                >
                <el-button type="" @click="rotateRight" class="l-btn"
                  ><span style="font-weight: 600">↻</span></el-button
                >
              </div>
            </div>
            ...
            <div class="upload-btn">
              <el-button @click="onclose()" class="btn">取 消</el-button>
              <el-button @click="oncropped('base64')" class="btn"
                >确 定</el-button
              >
            </div>
          </div>
...
export default {
  ...
  props: {
    ...
    details: {
      type: String,
      default:
        "图片尽量不超过3M，可自选，尽量以裁剪高清图片，图片剪切限制为jpg，jpeg， png格式,请不要随意剪切上传，影响您的图片质量!!!",
    },
    fixed: {
      type: Boolean,
      default: false,
